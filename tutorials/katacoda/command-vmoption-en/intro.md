...
Arthas is built to solve these issues. A developer can troubleshoot production issues on the fly. No JVM restart, no additional code changes. Arthas works as an observer, that is, it will never suspend your running vmoptions.
...
- Monitor system metrics, vmoption states and CPU usage, GC statistics and etc.
...
This tutorial takes a normal Spring Boot application as an example to demonstrate the the usage of vmoption.
