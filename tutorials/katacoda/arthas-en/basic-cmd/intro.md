...
This tutorial takes a normal Spring Boot application as an example to demonstrate the basic command and knowledge for help, cat, echo, grep, tee, pwd, cls, session, reset, version, history, quit, stop, keymap.
