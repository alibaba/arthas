...
#include <jni_md.h>
#include <jvmti.h>
#include "head/com_vdian_vclub_MemoryAnalyzer.h"
...
extern "C"
JNIEXPORT jobject JNICALL Java_com_vdian_vclub_MemoryAnalyzer_getInstances(JNIEnv *env, jclass thisClass, jclass klass) {
...
Java_com_vdian_vclub_MemoryAnalyzer_sumInstanceSize(JNIEnv *env, jclass thisClass, jclass klass) {
...
extern "C"
JNIEXPORT jlong JNICALL Java_com_vdian_vclub_MemoryAnalyzer_countInstances(JNIEnv *env, jclass thisClass, jclass klass) {
