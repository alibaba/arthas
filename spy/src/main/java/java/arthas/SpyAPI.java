...
public class SpyAPI {
    ...
    public static void atLine(Class<?> clazz, String methodInfo, Object target, Object[] args, int line, String[] varNames, Object[] vars) {
        spyInstance.atLine(clazz, methodInfo, target, args, line, varNames, vars);
    }
    ...
    public static abstract class AbstractSpy {
        ...
        public abstract void atLine(Class<?> clazz, String methodInfo, Object target,
            Object[] args, int line, String[] varNames, Object[] vars);
    }
    ...
    static class NopSpy extends AbstractSpy {
        ...
        @Override
        public void atLine(Class<?> clazz, String methodInfo, Object target, Object[] args,
            int line, String[] varNames, Object[] vars) {
