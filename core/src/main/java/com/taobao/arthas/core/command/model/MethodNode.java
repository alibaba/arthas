...
public class MethodNode extends TraceNode {
    ...
    /**
     * 是否为beforeInvoke方法，true为beforeInvoke，false为方法体入口的onBefore
     */
    ...
    public MethodNode(Integer id, String className, String methodName, Integer lineNumber, Boolean isInvoking) {
        this.nodeId = id;
