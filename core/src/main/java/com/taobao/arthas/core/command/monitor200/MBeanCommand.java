...
@Description("\nExamples:\n" +
             ...
             "  mbean -i1000 java.lang:type=Threading *Count\n" +
             Constants.WIKI + Constants.WIKI_HOME + "mbean")
public class MBeanCommand extends TimerCommand {
    ...
    private static final String TIMER_PREFIX = "Timer-for-arthas-mbean-";
