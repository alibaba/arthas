...
public class JvmCommand extends AnnotatedCommand {
    ...
    private void addGarbageCollectors(JvmModel jvmModel) {
        ...
        for (GarbageCollectorMXBean gcMXBean : garbageCollectorMXBeans) {
            jvmModel.addItem(group, gcMXBean.getName(),
                    new long[]{gcMXBean.getCollectionCount(), gcMXBean.getCollectionTime()}, "[count/time (ms)]");
        }
    }
    ...
    private void addMemory(JvmModel jvmModel) {
        ...
        jvmModel.addItem(group, "HEAP-MEMORY-USAGE",
                new long[]{heapMemoryUsage.getCommitted(),
        ...
        jvmModel.addItem(group,"NO-HEAP-MEMORY-USAGE",
                new long[]{nonHeapMemoryUsage.getCommitted(),
