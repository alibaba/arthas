...
import static com.taobao.arthas.core.command.monitor200.TimeTunnelTable.drawTimeTunnelTable;
...
public class TimeTunnelView extends ResultView<TimeTunnelModel> {
    ...
    public void draw(CommandProcess process, TimeTunnelModel timeTunnelModel) {
        ...
        if (timeTunnelModel.getTimeFragmentList() != null) {
            ...
            TimeTunnelTable.drawReturnObj(table, tf);
            ...
            TimeTunnelTable.drawWatchResults(table, timeTunnelModel.getWatchResults());
            process.write(RenderUtil.render(table, process.width()));
            ...
            if (replayResult.isReturn()) {
                TimeTunnelTable.drawPlayResult(table, replayResult.getReturnObj(), replayResult.getCost());
            } else {
