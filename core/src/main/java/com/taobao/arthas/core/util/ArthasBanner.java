...
public class ArthasBanner {
    ...
    private static final String WIKI = "https://arthas.aliyun.com/3.x/doc";
    private static final String TUTORIALS = "https://arthas.aliyun.com/3.x/doc/arthas-tutorials.html";
