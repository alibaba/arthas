import{_ as a,o as i,c as t,a as e,b as d,e as s,d as l,r}from"./app.d0414016.js";const c={},v=e("h1",{id:"reset",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#reset","aria-hidden":"true"},"#"),s(" reset")],-1),o={href:"https://arthas.aliyun.com/doc/arthas-tutorials.html?language=en&id=command-reset",target:"_blank",rel:"noopener noreferrer"},m=e("code",null,"reset",-1),u=s(" online tutorial"),h=l(`<div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Reset all classes that have been enhanced by Arthas. These enhanced classes will also be reset when Arthas server is <code>stop</code>.</p></div><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>$ reset -h
 USAGE:
