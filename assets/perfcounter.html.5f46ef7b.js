import{_ as s,o as i,c as d,a as e,b as r,e as a,d as t,r as l}from"./app.b8f28394.js";const o={},c=e("h1",{id:"perfcounter",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#perfcounter","aria-hidden":"true"},"#"),a(" perfcounter")],-1),v={href:"https://arthas.aliyun.com/doc/arthas-tutorials.html?language=en&id=command-perfcounter",target:"_blank",rel:"noopener noreferrer"},u=e("code",null,"perfcounter",-1),m=a(" online tutorial"),p=t(`<div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Check the current JVM Perf Counter information.</p></div><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>$ perfcounter
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,8);function h(b,f){const n=l("ExternalLinkIcon");return i(),d("div",null,[c,e("p",null,[e("a",v,[u,m,r(n)])]),p])}const j=s(o,[["render",h],["__file","perfcounter.html.vue"]]);export{j as default};
