import{_ as s,o as a,c as d,a as e,b as l,e as n,d as r,r as v}from"./app.b2be689e.js";const c={},t=e("h1",{id:"sysenv",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#sysenv","aria-hidden":"true"},"#"),n(" sysenv")],-1),m={href:"https://arthas.aliyun.com/doc/arthas-tutorials.html?language=en&id=command-sysenv",target:"_blank",rel:"noopener noreferrer"},u=e("code",null,"sysenv",-1),o=n(" online tutorial"),b=r(`<div class="custom-container tip"><p class="custom-container-title">TIP</p><p>View the current JVM environment variables.</p></div><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h3><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code> USAGE:
   sysenv [-h] [env-name]
