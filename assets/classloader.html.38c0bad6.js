import{_ as n,o as l,c as t,a,b as i,e as s,d as r,r as d}from"./app.761e42df.js";const c={},o=a("h1",{id:"classloader",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#classloader","aria-hidden":"true"},"#"),s(" classloader")],-1),u={href:"https://arthas.aliyun.com/doc/arthas-tutorials?language=en&id=command-classloader",target:"_blank",rel:"noopener noreferrer"},p=a("code",null,"classloader",-1),h=s(" online tutorial"),m=r(`<div class="custom-container tip"><p class="custom-container-title">TIP</p><p>View hierarchy, urls and classes-loading info for the class-loaders.</p></div><p><code>classloader</code> can search and print out the URLs for a specified resource from one particular classloader. It is quite handy when analyzing <code>ResourceNotFoundException</code>.</p><h2 id="options" tabindex="-1"><a class="header-anchor" href="#options" aria-hidden="true">#</a> Options</h2><table><thead><tr><th style="text-align:right;">Name</th><th style="text-align:left;">Specification</th></tr></thead><tbody><tr><td style="text-align:right;">[l]</td><td style="text-align:left;">list all classloader instances</td></tr><tr><td style="text-align:right;">[t]</td><td style="text-align:left;">print classloader&#39;s hierarchy</td></tr><tr><td style="text-align:right;">[a]</td><td style="text-align:left;">list all the classes loaded by all the classloaders (use it with great caution since the output can be huge)</td></tr><tr><td style="text-align:right;">[c:]</td><td style="text-align:left;">print classloader&#39;s hashcode</td></tr><tr><td style="text-align:right;"><code>[classLoaderClass:]</code></td><td style="text-align:left;">The class name of the ClassLoader that executes the expression.</td></tr><tr><td style="text-align:right;"><code>[c: r:]</code></td><td style="text-align:left;">using ClassLoader to search resource</td></tr><tr><td style="text-align:right;"><code>[c: load:]</code></td><td style="text-align:left;">using ClassLoader to load class</td></tr></tbody></table><h3 id="url-classes-options" tabindex="-1"><a class="header-anchor" href="#url-classes-options" aria-hidden="true">#</a> <code>--url-classes</code> options</h3><table><thead><tr><th style="text-align:right;">Name</th><th style="text-align:left;">Specification</th></tr></thead><tbody><tr><td style="text-align:right;"><code>--url-classes</code></td><td style="text-align:left;">Show relationship between loaded classes and <code>codeSource(URL/jar)</code> in a specific ClassLoader</td></tr><tr><td style="text-align:right;"><code>-d, --details</code></td><td style="text-align:left;">Details mode: list class names for each URL/jar (use <code>-n/--limit</code> to control output)</td></tr><tr><td style="text-align:right;"><code>--jar &lt;kw&gt;</code></td><td style="text-align:left;">Filter jar(URL) by keyword (contains match by default)</td></tr><tr><td style="text-align:right;"><code>--class &lt;kw&gt;</code></td><td style="text-align:left;">Filter classes by keyword/package (contains match by default)</td></tr><tr><td style="text-align:right;"><code>-E, --regex</code></td><td style="text-align:left;">Treat <code>--jar/--class</code> as regular expression (keyword match by default)</td></tr><tr><td style="text-align:right;"><code>-n, --limit &lt;N&gt;</code></td><td style="text-align:left;">In details mode, show at most N classes per URL/jar (100 by default)</td></tr></tbody></table><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><h3 id="view-statistics-categorized-by-class-type" tabindex="-1"><a class="header-anchor" href="#view-statistics-categorized-by-class-type" aria-hidden="true">#</a> View statistics categorized by class type</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>$ classloader
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="show-class-to-jar-url-relationship-for-a-specific-classloader" tabindex="-1"><a class="header-anchor" href="#show-class-to-jar-url-relationship-for-a-specific-classloader" aria-hidden="true">#</a> Show class-to-jar(URL) relationship for a specific ClassLoader</h3><p><code>--url-classes</code> shows which jar(URL) the classes come from, and how many classes are loaded for each jar(URL) in the specified ClassLoader.</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>$ classloader <span class="token parameter variable">-c</span> 3d4eac69 --url-classes
sun.misc.Launcher<span class="token variable">$AppClassLoader</span>@3d4eac69, hash:3d4eac69
 url                                            loadedClassCount
 file:/private/tmp/math-game.jar                 <span class="token number">42</span>
 file:/Users/hengyunabc/.arthas/lib/arthas-agent.jar  <span class="token number">15</span>
Affect<span class="token punctuation">(</span>row-cnt:2<span class="token punctuation">)</span> cost <span class="token keyword">in</span> <span class="token number">3</span> ms.
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Filter by jar name keyword and show details (list class names):</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>$ classloader <span class="token parameter variable">-c</span> 3d4eac69 --url-classes <span class="token parameter variable">-d</span> <span class="token parameter variable">--jar</span> math-game
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Filter further by package/keyword (will also output <code>matchedClassCount</code> for statistics):</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>$ classloader <span class="token parameter variable">-c</span> 3d4eac69 --url-classes <span class="token parameter variable">--jar</span> spring-core <span class="token parameter variable">--class</span> org.springframework
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,34);function v(b,g){const e=d("ExternalLinkIcon");return l(),t("div",null,[o,a("p",null,[a("a",u,[p,h,i(e)])]),m])}const k=n(c,[["render",v],["__file","classloader.html.vue"]]);export{k as default};
