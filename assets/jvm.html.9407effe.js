import{_ as s,o as l,c as a,a as e,b as d,e as i,d as r,r as v}from"./app.820675a4.js";const c={},m=e("h1",{id:"jvm",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#jvm","aria-hidden":"true"},"#"),i(" jvm")],-1),u={href:"https://arthas.aliyun.com/doc/arthas-tutorials.html?language=en&id=command-jvm",target:"_blank",rel:"noopener noreferrer"},t=e("code",null,"jvm",-1),b=i(" online tutorial"),o=r(`<div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Check the current JVM&#39;s info</p></div><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>$ jvm
RUNTIME
--------------------------------------------------------------------------------------------------------------
