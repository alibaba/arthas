...
returning:class=IbatisProductDao;method=getProductById;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function g(h,f){const t=l("RouterLink");return p(),i("div",null,[d,s("p",null,[r,v,c(t,{to:"/doc/advice-class.html"},{default:o(()=>[k]),_:1}),m]),b])}var w=e(u,[["render",g],["__file","groovy.html.vue"]]);export{w as default};
