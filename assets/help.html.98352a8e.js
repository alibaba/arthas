import{_ as n,o as s,c as e,d as a}from"./app.8a3762b8.js";const i={},t=a(`<h1 id="help" tabindex="-1"><a class="header-anchor" href="#help" aria-hidden="true">#</a> help</h1><p>show help message, the command can show all the commands that current Arthas server supports,or you can use the command to show the detail usage of another command.</p><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>[help command] equals [command -help],both is to show the detail usage of one command.</p></div><h3 id="options" tabindex="-1"><a class="header-anchor" href="#options" aria-hidden="true">#</a> Options</h3><table><thead><tr><th style="text-align:right;">Name</th><th style="text-align:left;">Specification</th></tr></thead><tbody><tr><td style="text-align:right;"></td><td style="text-align:left;">show all the commands that current Arthas server supports</td></tr><tr><td style="text-align:right;">[name:]</td><td style="text-align:left;">show the detail usage of one command</td></tr></tbody></table><h3 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>$ <span class="token builtin class-name">help</span>
 NAME         DESCRIPTION
 ...
 <span class="token function">mc</span>           Memory compiler, compiles java files into bytecode and class files <span class="token keyword">in</span> memory.
 ...
 EXAMPLES:
   dashboard
   dashboard -n <span class="token number">10</span>
   dashboard -i <span class="token number">2000</span>
 ...
 -i, --interval <span class="token operator">&lt;</span>value<span class="token operator">&gt;</span>                  The interval <span class="token punctuation">(</span>in ms<span class="token punctuation">)</span> between two executions, default is <span class="token number">5000</span> ms.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),l=[t];function o(c,d){return s(),e("div",null,l)}var p=n(i,[["render",o],["__file","help.html.vue"]]);export{p as default};
