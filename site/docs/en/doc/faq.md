...
Starting with Arthas 4.3.2, the terminal supports directly entering and editing Chinese and other Unicode characters.

In Arthas 4.3.1 and earlier, convert Unicode characters to the `\u` representation:
