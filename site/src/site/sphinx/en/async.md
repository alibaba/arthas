...
* If you do not want to exit the Arthas and continue to perform background tasks, you can exit the Arthas interface by executing q command (stop command will close the Arthas service)
