package com.alibaba.arthas.tunnel.server2.config.autoconfigure;

import com.alibaba.arthas.tunnel.server2.web.security.DelegateReactiveUserDetailsService;
