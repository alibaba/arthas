...
/**
 * @description: Etcd native agent client register implements NativeAgentClientRegistry
 * @author：flzjkl
 * @date: 2024-09-13 7:54
 */
public class EtcdNativeAgentClientRegistry implements NativeAgentClientRegistry {

    private static final Logger logger = LoggerFactory.getLogger(EtcdNativeAgentClientRegistry.class);
    ...
    public void registerNativeAgentClient(String address, String k, String v) {
        ...
        try {
            ByteSequence key = ByteSequence.from(NATIVE_AGENT_PREFIX + "/" + k, StandardCharsets.UTF_8);
